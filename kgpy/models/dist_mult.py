...
class DistMult(base_model.Model):
    def __init__(self, entities, relations, latent_dim=100, loss_margin=1, l2=0, l3=0.00001, init_weight_range=[-.8, .8]):
        super().__init__("DistMult", entities, relations, latent_dim, loss_margin, l2, l3, init_weight_range)
